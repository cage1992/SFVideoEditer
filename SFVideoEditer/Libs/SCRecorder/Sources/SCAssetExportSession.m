    ...
    if (watermarkImage != nil) {
        ...
        switch (self.videoConfiguration.watermarkAnchorLocation) {
            ...
            case SCWatermarkAnchorLocationBottomRight:
                ...
                watermarkFrame.origin.x = videoSize.width - watermarkFrame.size.width - watermarkFrame.origin.x;
                break;
            case SCWatermarkAnchorLocationCenter:
                watermarkFrame.origin.y = videoSize.height*0.5 - watermarkFrame.size.height*0.5 - watermarkFrame.origin.y-10;
                watermarkFrame.origin.x = videoSize.width*0.5 - watermarkFrame.size.width*0.5 - watermarkFrame.origin.x;
                break;
        }
